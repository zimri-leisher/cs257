...
class BooksDataSourceTester(unittest.TestCase):
    def setUp(self):
        ...
        self.data_source_large = BooksDataSource('books.csv')
    ...
    def test_unique_author(self):
        ...
        self.assertTrue(authors[0] == Author('Author', 'Three', None, None))
    ...
    def test_books_no_search_text(self):
        ...
        actual_books = [Book('One', 100, Author('Author', 'One')), Book('Two', 100, Author('Author', 'One')),
                        Book('Three', 200, Author('Author', 'Two')), Book('Three', 200, Author('Author', 'Three')),
    ...
    def test_books_default_sort(self):
        books = self.data_source_small.books(None)
        self.assertEqual(self.data_source_small.books(None, sort_by='title'), books)
